use crate::ion::utilities::parse_header::{
    ...
    HEADER_LEN_CHROM_FILTER, HEADER_LEN_CHROM_META, HEADER_LEN_GLOBAL_META,
    HEADER_LEN_PACKED_CHROMS, HEADER_LEN_PACKED_SPECTRA, HEADER_LEN_SPEC_ARRAYREFS,
    HEADER_LEN_SPEC_ENTRIES, HEADER_LEN_SPEC_FILTER, HEADER_LEN_SPEC_META, HEADER_OFF_CHROM_FILTER,
    HEADER_OFF_SPEC_FILTER, HEADER_OFFSET_CHROM_ARRAYREFS, HEADER_OFFSET_CHROM_ENTRIES,
    HEADER_OFFSET_CHROM_META, HEADER_OFFSET_GLOBAL_META, HEADER_OFFSET_PACKED_CHROMS,
    HEADER_OFFSET_PACKED_SPECTRA, HEADER_OFFSET_SPEC_ARRAYREFS, HEADER_OFFSET_SPEC_ENTRIES,
    HEADER_OFFSET_SPEC_META, HEADER_SPEC_ARRAY_TYPE_COUNT, HEADER_SPEC_META_CRC32,
    HEADER_SPEC_META_NUMERIC_COUNT, HEADER_SPEC_META_ROW_COUNT, HEADER_SPEC_META_STRING_COUNT,
    HEADER_SPEC_META_UNCOMPRESSED_SIZE, HEADER_SPECTRUM_BLOCK_COUNT, HEADER_SPECTRUM_COUNT,
    HEADER_TARGET_BLOCK_SIZE, HEADER_TOTAL_FILE_SIZE,
};
...
pub(crate) struct FileHeader {
    ...
    pub(crate) off_spec_filter: u64,
    pub(crate) len_spec_filter: u64,
    pub(crate) off_chrom_filter: u64,
    pub(crate) len_chrom_filter: u64,
...
impl FileHeader {
    pub(crate) fn write_into(&self, buf: &mut [u8]) {
        ...
        patch_u64_at(buf, HEADER_OFF_SPEC_FILTER, self.off_spec_filter);
        patch_u64_at(buf, HEADER_LEN_SPEC_FILTER, self.len_spec_filter);
        patch_u64_at(buf, HEADER_OFF_CHROM_FILTER, self.off_chrom_filter);
        patch_u64_at(buf, HEADER_LEN_CHROM_FILTER, self.len_chrom_filter);
